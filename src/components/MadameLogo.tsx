...
//
// O componente:
//   - Server Component (zero JS no client por padrão, exceto o Image que já é otimizado)
//   - Aceita `width`/`height`/`className`/`alt` pra controlar tamanho e acessibilidade
//   - Quando o asset for atualizado, basta substituir public/logo-madame-lash.jpg
//
// Substitui a versão SVG inline (gradiente improvisado) que existia antes.
